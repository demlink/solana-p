...
import BufferLayout, { Layout } from "@solana/buffer-layout";
import {
  Connection,
  PublicKey,
  Commitment,
...
import { AccountState } from "@solana/spl-token-v3";
...
export function createTransferInstruction(
  ...
  const dataLayout = BufferLayout.struct([
    BufferLayout.u8("instruction") as Layout<never>,
    BufferLayout.blob(8, "amount") as any,
  ]);
