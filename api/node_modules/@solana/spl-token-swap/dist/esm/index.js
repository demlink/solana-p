...
class TokenSwap {
     ...
     */
    async swap(userSource, poolSource, poolDestination, userDestination, sourceMint, destinationMint, sourceTokenProgramId, destinationTokenProgramId, hostFeeAccount, userTransferAuthority, amountIn, minimumAmountOut, confirmOptions) {
     ...
     */
    async depositSingleTokenTypeExactAmountIn(userAccount, poolAccount, sourceMint, sourceTokenProgramId, userTransferAuthority, sourceTokenAmount, minimumPoolTokenAmount, confirmOptions) {
     ...
     */
    async withdrawSingleTokenTypeExactAmountOut(userAccount, poolAccount, destinationMint, destinationTokenProgramId, userTransferAuthority, destinationTokenAmount, maximumPoolTokenAmount, confirmOptions) {
